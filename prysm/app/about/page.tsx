    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 lg:py-32">
        <div className="text-center mb-20">
          <div className="flex justify-center mb-6">
            <Badge variant="purple" className="inline-flex items-center gap-2 px-5 py-2.5 text-sm">
              <i className="fa-solid fa-sparkles"></i>
              <span>Our Story</span>
            </Badge>
          </div>
          <h1 className="text-5xl lg:text-7xl font-extrabold mb-6">
            Building the Future of <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Education</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            We're on a mission to revolutionize how SADC students learn, study,
            and succeed. Prysm isn't just another app—it's your complete academic
            operating system.
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6">
              Who <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">We Are</span>
            </h2>
            <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
              <p>
                Prysm is an innovative education technology company founded with a
                singular vision: to centralize and simplify the academic journey
                for millions of students across the Southern African Development
                Community (SADC).
              </p>
              <p>
                Born from the frustration of juggling multiple apps, scattered
                notes, and fragmented study resources, Prysm represents the first
                truly unified platform designed specifically for African students.
                We understand the unique challenges students face—from accessing
                curriculum-specific exam papers to managing complex study
                schedules across different syllabuses.
              </p>
              <p>
                Our platform harnesses cutting-edge artificial intelligence to
                provide intelligent insights, automate tedious tasks, and deliver
          ...
          <Card className="academy-card p-8">
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-6 bg-white/5 rounded-xl">
                ...
                <p className="text-3xl font-extrabold text-white mb-2">Growing</p>
              ...
              <div className="text-center p-6 bg-white/5 rounded-xl">
                ...
                <p className="text-3xl font-extrabold text-white mb-2">3</p>
              ...
              <div className="text-center p-6 bg-white/5 rounded-xl">
                ...
                <p className="text-3xl font-extrabold text-white mb-2">42,000+</p>
                <p className="text-sm text-gray-400">Exam Papers</p>
              </div>
              <div className="text-center p-6 bg-white/5 rounded-xl">
                ...
                <p className="text-3xl font-extrabold text-white mb-2">2026</p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12">
          <Card className="academy-card p-10">
            <div className="w-20 h-20 rounded-2xl bg-lime-400/20 flex items-center justify-center mb-6">
              <i className="fa-solid fa-bullseye text-lime-400 text-3xl"></i>
            </div>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              ...
              that eliminate academic friction, streamline learning workflows, and
              unlock their full potential. We believe that access to organized,
              AI-enhanced educational resources should be universal, not a
              privilege.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed mt-4">
              By integrating exam preparation, note-taking, scheduling, and study
              analytics into one cohesive platform, we're not just building
              software—we're building the foundation for academic excellence
              across the region.
            </p>
          </Card>
          <Card className="academy-card p-10">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mt-4">
              ...
              curriculum-aligned resources, AI-powered study recommendations, and
              collaborative tools that make learning intuitive, efficient, and
              genuinely enjoyable.
            </p>
          </Card>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-6">
            How It All <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Started</span>
          </h2>
        </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    papers buried in WhatsApp groups, study schedules scribbled on
                    paper, and no single source of truth for curriculum-specific
                    resources. We spent more time organizing than actually
                    studying.
                  </p>
                </div>
              </div>
            ...
            <Card className="academy-card p-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    We realized that what students needed wasn't another app—it
                    was a complete ecosystem. A unified platform that combines
                    AI-powered insights with intuitive design, specifically
                    tailored to SADC curricula. Thus, Prysm was born: the Ultimate
                    Student OS that centralizes everything you need to succeed.
                  </p>
                </div>
              </div>
            </Card>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    and parent dashboards, we're building not just for today, but
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-6">
            Our Core <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Values</span>
          </h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { icon: 'fa-graduation-cap', title: 'Student-First', bgClass: 'bg-lime-400/20', textClass: 'text-lime-400', desc: 'Every feature, every decision, every innovation is driven by what students actually need. We build for students, with students.' },
            { icon: 'fa-globe-africa', title: 'Local Focus', bgClass: 'bg-purple-400/20', textClass: 'text-purple-400', desc: 'Built specifically for SADC curricula, exam boards, and educational systems. We understand your context because we share it.' },
            { icon: 'fa-brain', title: 'AI-Powered', bgClass: 'bg-orange-400/20', textClass: 'text-orange-400', desc: 'Harnessing the latest AI to provide intelligent insights, predictions, and personalized recommendations that make studying smarter, not harder.' },
            { icon: 'fa-lock', title: 'Privacy & Security', bgClass: 'bg-blue-400/20', textClass: 'text-blue-400', desc: 'Your data is yours. We implement enterprise-grade security to protect your academic information and respect your privacy.' },
            { icon: 'fa-trophy', title: 'Excellence', bgClass: 'bg-red-400/20', textClass: 'text-red-400', desc: "We're committed to building world-class software that rivals global education platforms while remaining accessible and relevant to African students." },
            { icon: 'fa-handshake', title: 'Accessibility', bgClass: 'bg-green-400/20', textClass: 'text-green-400', desc: "Core features free forever. We believe premium education tools shouldn't come with premium price tags for essential functionality." },
          ].map((value, idx) => (
            <Card key={idx} className="academy-card p-8 text-center">
              <div className={`w-16 h-16 rounded-xl ${value.bgClass} flex items-center justify-center mx-auto mb-4`}>
                <i className={`fa-solid ${value.icon} ${value.textClass} text-2xl feature-icon`}></i>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-6">
            What We're <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Building</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="academy-card p-8">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              The largest repository of SADC exam papers with AI-powered insights.
              Discover trending topics, frequently asked questions, and
              intelligent predictions to focus your revision where it matters
              most.
            </p>
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center gap-2">
                <i className="fa-solid fa-check text-lime-400 text-xs"></i>
                <span>42,000+ exam papers across NSSCO, CAPS, IEB, EGCSE, IGCSE, ZIMSEC, and BGCSE</span>
              </li>
              <li className="flex items-center gap-2">
                <i className="fa-solid fa-check text-lime-400 text-xs"></i>
          ...
          <Card className="academy-card p-8">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              ...
              diagrams, annotate materials, and organize everything in one place.
              Link notes to syllabus chapters for seamless organization.
            </p>
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center gap-2">
          ...
          <Card className="academy-card p-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-2xl font-extrabold">YouTube AI Intelligence</h3>
            </div>
            <p className="text-gray-300 leading-relaxed mb-4">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <Card className="academy-card p-8 sm:p-12">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6">
              Building a <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Better Future</span>
            </h2>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl lg:text-5xl font-extrabold mb-6">
            Let's <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Connect</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Card className="academy-card p-8 text-center">
            ...
            <a href="mailto:support@prysmlearn.com" className="text-lime-400 hover:text-lime-300 transition-colors">
          ...
          <Card className="academy-card p-8 text-center">
            ...
            <a href="tel:+264814989258" className="text-lime-400 hover:text-lime-300 transition-colors">
              +264 81 498 9258
            </a>
          </Card>
          <Card className="academy-card p-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><Link href="/examhub" className="hover:text-lime-400 transition-colors">Exam Hub</Link></li>
              <li><Link href="/canvas" className="hover:text-lime-400 transition-colors">Drawing Board</Link></li>
              <li><Link href="/autoplanner" className="hover:text-lime-400 transition-colors">Auto-Planner</Link></li>
              <li><Link href="/youtubeai" className="hover:text-lime-400 transition-colors">YouTube AI</Link></li>
              <li><Link href="/parenthub" className="hover:text-lime-400 transition-colors">Parent Hub</Link></li>
            </ul>
          </div>
          <div>
