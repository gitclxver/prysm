              ...
              <div className="relative bg-[var(--prysm-bg)] rounded-2xl p-6 border border-[var(--border-color)]">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="px-3 py-1 bg-[var(--lime)]/10 rounded-full border border-[var(--lime)]/30">
                    <span className="text-[10px] text-[var(--lime)] font-bold uppercase">Tutor Hub</span>
                  </div>
                </div>
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-[var(--lime)]/20 flex items-center justify-center">
                          <i className="fa-solid fa-user-graduate text-[var(--lime)] text-sm"></i>
                        </div>
                        <div>
                          <p className="text-xs text-[var(--text-secondary)]">Recommended for You</p>
                          <p className="text-sm font-bold text-[var(--text-primary)]">Sarah M.</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <i key={i} className="fa-solid fa-star text-[var(--lime)] text-xs"></i>
                        ))}
                      </div>
                    </div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-xs text-[var(--text-secondary)]">Biology • NSSCO</span>
                      <span className="text-xs text-[var(--lime)] font-bold">4.9/5.0</span>
                    </div>
                  ...
                  <div className="bg-[var(--lime)]/10 rounded-xl p-4 border border-[var(--lime)]/20">
                    <p className="text-xs font-bold text-[var(--lime)] uppercase mb-2">AI Recommendation</p>
                  ...
                  <div className="bg-[var(--bg-overlay)] rounded-lg p-3 border border-[var(--border-color)]">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-[var(--text-secondary)]">Available Today</span>
                      <button className="px-4 py-1.5 bg-[var(--lime)] text-[var(--prysm-bg)] rounded-lg text-xs font-bold hover:bg-[var(--lime)]/80 transition-colors">
                        Request Session
                      </button>
                    </div>
                  </div>
