                  ...
                  <div className="bg-[var(--bg-overlay)] rounded-xl p-4 border border-[var(--border-color)]">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <p className="text-xs text-[var(--text-secondary)]">Biology Tutorial</p>
                        <p className="text-sm font-bold text-[var(--text-primary)]">Enzymes Explained</p>
                      </div>
                    </div>
                    <div className="h-1.5 bg-[var(--bg-overlay)] rounded-full overflow-hidden mb-2">
                      <div className="h-full bg-orange-400/30 rounded-full" style={{ width: '75%' }}></div>
                    </div>
                    <p className="text-xs text-[var(--text-secondary)]">Processing transcript... 75%</p>
                  </div>
                  <div className="bg-orange-400/10 rounded-xl p-4 border border-orange-400/20">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-[var(--text-primary)]">Transcript Generated</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <i className="fa-solid fa-check text-orange-400 text-xs"></i>
                        <span className="text-xs text-[var(--text-primary)]">Key Points Extracted</span>
                      </div>
                    </div>
                  </div>
                </div>
