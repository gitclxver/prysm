      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6">
            Prysm <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Community</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center mb-16 sm:mb-20">
              ...
              <div className="relative bg-[#120d2b] rounded-2xl p-6 border border-white/5">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="px-3 py-1 bg-lime-400/10 rounded-full border border-lime-400/30">
                    <span className="text-[10px] text-lime-400 font-bold uppercase">Community Hub</span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/5">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-10 h-10 rounded-full bg-lime-400/20 flex items-center justify-center">
                        <i className="fa-solid fa-upload text-lime-400 text-sm"></i>
                      </div>
                      <div className="flex-1">
                        <p className="text-xs text-gray-400">Uploading Exam Paper</p>
                        <p className="text-sm font-bold text-white">NSSCO Biology 2023</p>
                      </div>
                      <div className="h-2 w-2 rounded-full bg-lime-400 animate-pulse"></div>
                    </div>
                    <div className="h-2 bg-white/5 rounded-full overflow-hidden mb-2">
                      <div className="h-full bg-lime-400/30 rounded-full" style={{ width: '75%' }}></div>
                    </div>
                    <p className="text-xs text-gray-400">Processing... 75%</p>
                  </div>
                  <div className="bg-lime-400/10 rounded-xl p-4 border border-lime-400/20">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-xs text-gray-300">
                        <i className="fa-solid fa-comment text-lime-400"></i>
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-4 sm:mb-6">
              Build Together, <span className="text-[#e0d7ff]">Succeed Together</span>
            </h2>
        ...
        <AnimatedCard delay={0.7}>
          <Card className="academy-card p-8 sm:p-12 bg-gradient-to-br from-[#1d163d] to-[#120d2b] border-2 border-lime-400/20">
            <div className="text-center mb-8">
              <h3 className="text-2xl sm:text-3xl font-extrabold mb-4">
                A Thriving <span className="bg-gradient-to-r from-[#d4ff80] to-[#e0d7ff] bg-clip-text text-transparent">Learning Ecosystem</span>
              </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-white/5 rounded-xl">
                <div className="w-12 h-12 rounded-full bg-lime-400/20 flex items-center justify-center mx-auto mb-3">
                  <i className="fa-solid fa-users text-lime-400 text-xl"></i>
                </div>
                <p className="text-2xl font-extrabold text-white mb-1">Growing</p>
              ...
              <div className="text-center p-4 bg-white/5 rounded-xl">
                ...
                <p className="text-2xl font-extrabold text-white mb-1">Shared</p>
              ...
              <div className="text-center p-4 bg-white/5 rounded-xl">
                ...
                <p className="text-2xl font-extrabold text-white mb-1">Active</p>
              ...
              <div className="text-center p-4 bg-white/5 rounded-xl">
                ...
                <p className="text-2xl font-extrabold text-white mb-1">Study</p>
