...
export default function LoginPage() {
  ...
  // Temporarily disable Google and passwordless auth in production
  // Set to false to enable, or check environment variable
  const isProduction = typeof window !== 'undefined' && 
    (window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1');
  const enableGoogleAuth = !isProduction; // Disable in production
  const enablePasswordlessAuth = !isProduction; // Disable in production
