        ...
        <div className="space-y-8">
          ...
          <Card className="p-8">
            ...
            <ul className="space-y-3 text-[var(--text-secondary)]">
              <li className="flex items-start gap-3">
                <i className="fa-solid fa-check text-[var(--lime)] mt-1"></i>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-3">
              <div>
                <h3 className="font-bold text-[var(--text-primary)] mb-2">Essential Cookies</h3>
                <p className="text-[var(--text-secondary)] text-sm">Required for the site to function properly. These cannot be disabled.</p>
              </div>
              <div>
                <h3 className="font-bold text-[var(--text-primary)] mb-2">Authentication Cookies</h3>
                <p className="text-[var(--text-secondary)] text-sm">Used to maintain your login session and security.</p>
              </div>
              <div>
                <h3 className="font-bold text-[var(--text-primary)] mb-2">Analytics Cookies</h3>
                <p className="text-[var(--text-secondary)] text-sm">Help us understand how visitors interact with our website.</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-8">
            ...
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">You have the right to:</p>
            <ul className="space-y-2 text-[var(--text-secondary)] list-disc list-inside">
