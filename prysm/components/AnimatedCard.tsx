...
export function AnimatedCard({ children, className = '', hover = true, delay = 0 }: AnimatedCardProps) {
  return (
    <motion.div
      ...
      className={`bg-[#1d163d] border border-white/5 rounded-2xl p-8 transition-all duration-400 relative overflow-hidden ${hover ? 'hover:border-[#d4ff80] hover:bg-gradient-to-br hover:from-[#251c4a] hover:to-[#1d163d] hover:shadow-[0_20px_40px_rgba(212,255,128,0.1)]' : ''} ${className}`}
    >
      {hover && (
